...
You can force split a group if you want in order to do that rename the picture that will start the splitted group with `-x`at the end e.g. `1365710422-b5a4a5696a29669e.jpg` -> `1365710422-b5a4a5696a29669e-x.jpg` then re-launch the `group` command
