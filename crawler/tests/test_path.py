...
from app.tools.path import FileNotFoundException, MalformedFileNameException, PicturePath
...
class TestPicturePath(unittest.TestCase):
    ...
    def test_picture_path_ok(self):
        test_path = Path('tests/files/photos/2024/ANYTHING/1733616335-e7975821ce2e1a55.jpg')
        ...
        self.assertEqual(picture_path.get_folder_path(), Path('tests/files/photos/2024/ANYTHING'))
        self.assertEqual(picture_path.get_hash(), 'e7975821ce2e1a55')

    def test_picture_path_not_exists(self):
        test_path = Path('tests/files/photos/2024/ANYTHING/does-not-exist-1733616335-e7975821ce2e1a55.jpg')
    ...
    def test_picture_path_malformed_name(self):
        test_path = Path('tests/files/photos/2024/ANYTHING/91733616335-e7975821ce2e1a55.jpg')
